...
- Base CMS 1.0.19 Stable and Eduvixo theme 1.1.11 published to Marketplace and both production installations.

## Production

- `demo.eduvixo.com`: Base CMS 1.0.19, active Eduvixo theme preserved, SMTP configured with an encrypted password.
- `shoudu.lrn.asia`: Base CMS 1.0.19, active Shoudu Custom Theme preserved, existing transport configuration retained.
